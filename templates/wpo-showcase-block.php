...
$rating      = ( 0 == $rating ? __('none', 'list-plugin-details' ) : $rating .= '/5' );
...
<div class="<?php echo $settings[ 'lpd-row-class' ] ?>">
    ...
    <div class="<?php echo $settings[ 'lpd-card-class' ] ?>">
        ...
        <div class="<?php echo $settings[ 'lpd-button-cover' ] ?>">
            <div class="<?php echo $settings[ 'lpd-button' ] ?>"><a href="<?php echo $meta[ 'download_link' ]; ?>" class="<?php echo $settings[ 'lpd-button-a' ] ?>" target="_blank"><?php _e('Download', 'list-plugin-details' ); ?></a></div>
        </div>
        ...
        <p><i class="fas fa-download" style="color: #2e2e2e">&nbsp;</i><?php _e('Downloads:', 'list-plugin-details' ); ?> <?php echo number_format_i18n( $meta[ 'downloads' ] ); ?>
            <br><i class="fas fa-star" style="color: #2e2e2e"></i>&nbsp;<?php _e('Rating:', 'list-plugin-details' ); ?> <?php echo $rating ; ?>
            <?php if ( 0 <> $meta[ 'num_ratings' ] ) : ?>
            <br><i class="fas fa-user-edit" style="color: #2e2e2e"></i>&nbsp;<?php _e('Reviews:', 'list-plugin-details' ); ?> <?php echo $meta[ 'num_ratings' ] ; ?>
            <?php endif; ?>
        </p>
    </div>
    <?php if ( $close_block ) : ?>
